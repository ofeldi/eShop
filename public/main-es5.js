...
/* harmony import */ var angular_font_awesome__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! angular-font-awesome */ "./node_modules/angular-font-awesome/dist/angular-font-awesome.es5.js");
/* harmony import */ var countup_js_angular2__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! countup.js-angular2 */ "./node_modules/countup.js-angular2/fesm5/countup.js-angular2.js");
...
var AppModule = /** @class */ (function () {
    function AppModule(devTools) {
        var enhancers = Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["isDevMode"])() ? [devTools.enhancer()] : [];
...
var AddModalComponent = /** @class */ (function () {
    function AddModalComponent(productService, authService, formBuilder, dialogRef, data) {
    ...
    AddModalComponent.prototype.save = function () {
        var _this = this;
        var formValues = this.addProductForm.getRawValue();
        var newProduct = {
        ...
        this.productService.createNewProduct(newProduct, this.adminToken).subscribe(function (data) {
            _this.dialogRef.close(data);
        });
    };
    AddModalComponent.prototype.capFirstLetter = function (string) {
        return string.charAt(0).toUpperCase() + string.slice(1);
    };
    AddModalComponent.prototype.allowNumberOnly = function (e) {
...
var AdminPageComponent = /** @class */ (function () {
    function AdminPageComponent(authService, router, productsService, categoryService, formBuilder, dialog) {
        this.authService = authService;
        this.router = router;
    ...
    AdminPageComponent.prototype.getAllProducts = function () {
        var _this = this;
        this.productsService.getAllProducts().subscribe(function (data) {
            _this.products = data;
            _this.productsLength = _this.products.length;
        });
    };
    AdminPageComponent.prototype.getAllCategories = function () {
        var _this = this;
        this.categoryService.geAllCategories().subscribe(function (data) {
            _this.convertArrToObject(data);
        });
    };
    AdminPageComponent.prototype.convertArrToObject = function (productsArray) {
        var productsObj = {};
    ...
    AdminPageComponent.prototype.capFirstLetter = function (string) {
        return string.charAt(0).toUpperCase() + string.slice(1);
    };
    AdminPageComponent.prototype.openeEditDialog = function (productsValues, categoriesObject) {
        var _this = this;
        var dialogRef = this.dialog.open(_edit_modal_edit_modal_component__WEBPACK_IMPORTED_MODULE_8__["EditModalComponent"], {
            data: {
    ...
    AdminPageComponent.prototype.openAddDialog = function (categoriesObject) {
        var _this = this;
        var dialogRef = this.dialog.open(_add_modal_add_modal_component__WEBPACK_IMPORTED_MODULE_9__["AddModalComponent"], {
            data: {
                categories: categoriesObject
            }
        });
...
var EditModalComponent = /** @class */ (function () {
    function EditModalComponent(productService, authService, formBuilder, dialogRef, data) {
        this.productService = productService;
        this.authService = authService;
        this.formBuilder = formBuilder;
        this.dialogRef = dialogRef;
    ...
    EditModalComponent.prototype.ngOnInit = function () {
        ...
        var editForm = this.editProductForm.controls;
        var preEditFields = this.data.preEditFields;
    ...
    EditModalComponent.prototype.save = function (productID) {
        var _this = this;
        var newFormValues = this.editProductForm.getRawValue();
        var editedProduct = {
        ...
        this.productService.editProduct(productID, editedProduct, this.adminToken).subscribe(function (data) {
            _this.dialogRef.close(data);
        });
    };
    EditModalComponent.prototype.capFirstLetter = function (string) {
        return string.charAt(0).toUpperCase() + string.slice(1);
    };
    EditModalComponent.prototype.allowNumberOnly = function (e) {
        var code = (e.which) ? e.which : e.keycode;
        if (code > 31 && (code < 48 || code > 57)) {
            e.preventDefault();
        }
    };
    EditModalComponent.ctorParameters = function () { return [
        { type: _services_product_service__WEBPACK_IMPORTED_MODULE_4__["ProductService"] },
        { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(productService, authService, cartService, orderService) {
        this.productService = productService;
        this.authService = authService;
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.cartService.getUserCartStatus(this.userId, this.userToken).subscribe(function (data) {
            ...
            if (data.status === 0) {
                _this.authService.storeCartData(data.cart);
                _this.orderService.getLatestOrderByUserId(_this.userId, _this.userToken).subscribe(function (date) {
                    console.log(date[0]);
                    if (date[0]) {
                        _this.dashBoardMsg = "Welcome back, no opened carts were found. Your last order's date is: " + (new _angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"]("en").transform(date[0].orderDate, "dd/MM/yyyy"));
                    }
                    else {
                        _this.dashBoardMsg = "Welcome to our shop, Enjoy your first buy ♥";
                    }
                });
                return;
            }
            if (data.status === 1) {
                _this.authService.storeCartData(data.cart);
                _this.dashBoardMsg = "You have an opened cart from " + (new _angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"]("en").transform(data.msg, "dd/MM/yyyy"));
                return;
            }
            else {
                var userId = { userId: _this.userId };
                _this.cartService.createNewCart(userId, _this.userToken).subscribe(function (data) {
                    _this.authService.storeCartData(data.cart);
                    _this.dashBoardMsg = "Welcome to our shop, Enjoy your first buy ♥";
                });
            }
        ...
        this.productService.getAllProducts().subscribe(function (data) {
            _this.numOfProducts = Object.keys(data).length;
            setTimeout(function () {
                _this.isLoading = false;
            }, 300);
        });
        this.orderService.getAllOrdersLength().subscribe(function (data) {
            _this.numOfOrders = data;
        });
    };
    DashboardComponent.prototype.capFirstLetter = function (string) {
        return string.charAt(0).toUpperCase() + string.slice(1);
    };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(productService, orderService, authService) {
        this.productService = productService;
        this.orderService = orderService;
        this.authService = authService;
    }
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.productService.getAllProducts().subscribe(function (data) {
            _this.numOfProducts = data.length;
...
var InvoiceComponent = /** @class */ (function () {
    function InvoiceComponent(authService, productService, orderService) {
        this.authService = authService;
        this.productService = productService;
        this.orderService = orderService;
        this.isLoading = true;
    ...
    InvoiceComponent.prototype.captureScreen = function () {
    ...
    InvoiceComponent.prototype.convertArrToObject = function (productsArray) {
        var productsObj = {};
        for (var i = 0; i < productsArray.length; i++) {
            productsObj[productsArray[i]._id] = productsArray[i];
        }
    ...
    InvoiceComponent.prototype.setTotalCartProductsQuantity = function () {
        var cartProductsQuantityArr = this.currentCartProducts.map(function (obj) { return obj.quantity; });
        this.totalCartProductsQuantity = cartProductsQuantityArr.reduce(function (a, b) { return a + b; }, 0);
    };
    InvoiceComponent.prototype.capFirstLetter = function (string) {
        return string.charAt(0).toUpperCase() + string.slice(1);
    };
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.capFirstLetter = function (string) {
        return string.charAt(0).toUpperCase() + string.slice(1);
    };
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onUserLogin = function () {
        var _this = this;
        var loginDetails = this.loginForm.getRawValue();
        this.authService.loginUser(loginDetails).subscribe(function (data) {
            if (data.admin) {
                _this.authService.storeUserData(data.token, data.admin);
                _this.authService.loadUserPayload();
            ...
            if (err.status === 400) {
                Object.keys(err.error).forEach(function (prop) {
...
var OrderComponent = /** @class */ (function () {
    function OrderComponent(authService, productService, cartService, orderService, router) {
        var _this = this;
        this.authService = authService;
        this.productService = productService;
        this.cartService = cartService;
        ...
        this.myFilter = function (d) {
            var day = d.getDay();
            return (!_this.occupiedDates.includes(d.valueOf()));
        };
        this.dateClass = function (d) {
            var day = d.getDate();
            return (_this.occupiedDates.includes(d.valueOf())) ? 'occupied-date-class' : undefined;
        };
    }
    ...
    OrderComponent.prototype.getAllProducts = function () {
        var _this = this;
        this.productService.getAllProducts().subscribe(function (data) {
            _this.convertArrayToObject(data);
            _this.isLoading = false;
        });
    };
    OrderComponent.prototype.convertArrayToObject = function (productsArray) {
        var productsObj = {};
        for (var i = 0; i < productsArray.length; i++) {
            productsObj[productsArray[i]._id] = productsArray[i];
        }
    ...
    OrderComponent.prototype.setUserAddress = function () {
        this.authService.loadUserPayload();
    ...
    OrderComponent.prototype.onOrderSubmit = function () {
        var _this = this;
        var orderDetails = this.orderForm.getRawValue();
        var creditCard = orderDetails.creditCard.toString();
        var deliveryDate = new _angular_common__WEBPACK_IMPORTED_MODULE_7__["DatePipe"]('en').transform(orderDetails.deliveryDate, 'yyyy/MM/dd');
        ...
        this.orderService.createNewOrder(order, this.userToken).subscribe(function (data) {
            console.log(data);
            if (data.success) {
                var userId = { userId: _this.userId };
                _this.cartService.createNewCart(userId, _this.userToken).subscribe(function (data) {
            ...
            if (err.status === 400) {
                Object.keys(err.error).forEach(function (prop) {
                    var formControl = _this.orderForm.get(prop);
                    if (formControl) {
                        formControl.setErrors({
                            serverError: err.error[prop]
                        });
    ...
    OrderComponent.prototype.getOccupiedDates = function () {
        var _this = this;
        this.orderService.getOccupiedDates(this.userToken).subscribe(function (data) {
            _this.occupiedDates = data.map(function (obj) { return new Date(obj.date).getTime(); });
        });
    };
    OrderComponent.prototype.setTotalCartProductsQuantity = function () {
        var cartProductsQuantityArr = this.currentCartProducts.map(function (obj) { return obj.quantity; });
        this.totalCartProductsQuantity = cartProductsQuantityArr.reduce(function (a, b) { return a + b; }, 0);
    };
...
var ShopComponent = /** @class */ (function () {
    function ShopComponent(authService, productService, categoryService, cartService) {
        this.authService = authService;
        this.productService = productService;
        this.categoryService = categoryService;
        this.cartService = cartService;
    ...
    ShopComponent.prototype.ngOnInit = function () {
        ...
        this.productService.getAllProducts().subscribe(function (data) {
            _this.convertArrayToObject(data);
            _this.productsLength = Object.keys(data).length;
            console.log("products for cart: ", _this.productsForCart);
            console.log("all products ", _this.products);
        });
        this.setTotalCartProductsQuantity();
    };
    ShopComponent.prototype.addToCart = function (productId) {
        var cartProduct = this.currentCartProducts.find(function (product) { return product._id === productId; });
    ...
    ;
    ShopComponent.prototype.addItem = function () {
        this.quantity = this.quantity + 1;
    };
    ShopComponent.prototype.removeItem = function () {
        if (this.quantity > 1) {
            this.quantity = this.quantity - 1;
        }
    };
    ShopComponent.prototype.sendToCart = function (_id, quantity) {
        var _this = this;
        var addedProduct = { _id: _id, quantity: quantity };
        var cartId = this.cartId;
        var cartStatus = this.authService.userCart.isOpen;
        if (cartStatus === 0) {
            var setOpenCart = { isOpen: 1, date: new Date() };
            this.updateCartStatus(cartId, setOpenCart);
        }
        this.cartService.addProductToCart(cartId, addedProduct, this.userToken).subscribe(function (data) {
            _this.updateLocalStorage(data);
            console.log(addedProduct);
            _this.setTotalPrice();
            _this.setTotalCartProductsQuantity();
        });
    };
    ;
    ShopComponent.prototype.updateCartStatus = function (cartId, setOpenCart) {
        var _this = this;
        this.cartService.updateCartStatus(cartId, setOpenCart, this.userToken).subscribe(function (data) {
            _this.updateLocalStorage(data);
        });
    };
    ShopComponent.prototype.updateLocalStorage = function (cartData) {
        this.authService.storeCartData(cartData);
        this.authService.loadUserCart();
        this.currentCartProducts = this.authService.userCart.products;
    };
    ShopComponent.prototype.filterProductsByCategory = function (categoryId) {
        var _this = this;
        // console.log(categoryId)
        this.categoryId = categoryId;
        this.productService.getProductsByCategoryId(categoryId).subscribe(function (data) {
            _this.ProductsByCategory = data;
            _this.searchInputOn = false;
        });
    };
    ;
    ShopComponent.prototype.showAllProducts = function () {
        this.ProductsByCategory = null;
        this.searchInputOn = true;
        this.categoryId = null;
    };
    ShopComponent.prototype.deleteProductFromCart = function (_id) {
        var _this = this;
        var productId = { _id: _id };
        this.cartService.deleteProductFromCart(this.cartId, productId, this.userToken).subscribe(function (data) {
            console.log(data);
            _this.updateLocalStorage(data);
            _this.setTotalPrice();
        });
        if (this.currentCartProducts.length == 1) {
            var setOpenCart = { isOpen: 0 };
            this.updateCartStatus(this.cartId, setOpenCart);
            this.setTotalCartProductsQuantity();
        }
    };
    ShopComponent.prototype.deleteAllProductsFromCart = function () {
        var _this = this;
        this.cartService.deleteAllProductsFromCart(this.cartId, this.userToken).subscribe(function (data) {
            console.log(data);
            _this.updateLocalStorage(data);
            _this.setTotalCartProductsQuantity();
        });
    ...
    ShopComponent.prototype.setTotalPrice = function () {
        var _this = this;
        this.totalCartPrice = 0;
        for (var i = 0; i < this.currentCartProducts.length; i++) {
            this.totalCartPrice += this.currentCartProducts[i].quantity * this.productsForCart[this.currentCartProducts[i]._id].price;
        }
        var totalCartPrice = { totalCartPrice: this.totalCartPrice };
        this.cartService.setCartTotalPrice(this.cartId, totalCartPrice, this.userToken).subscribe(function (data) {
            console.log(data);
            _this.updateLocalStorage(data);
        });
    };
    ShopComponent.prototype.onUserSearch = function (searchValue) {
        var _this = this;
        this.productService.searchProduct(searchValue).subscribe(function (data) {
            var valueFound = data;
            var results = {};
            for (var i = 0; i < valueFound.length; i++) {
                results[valueFound[i]._id] = valueFound[i];
            }
            _this.products = results;
            _this.numOfSearchResults = valueFound.length;
        });
    };
    ShopComponent.prototype.convertArrayToObject = function (productsArray) {
        var productsObject = {};
        for (var i = 0; i < productsArray.length; i++) {
    ...
    ShopComponent.prototype.capFirstLetter = function (string) {
        return string.charAt(0).toUpperCase() + string.slice(1);
    };
    ShopComponent.prototype.allowNumberOnly = function (e) {
        var code = (e.which) ? e.which : e.keycode;
        if (code > 31 && (code < 48 || code > 57)) {
            e.preventDefault();
        }
    };
    ShopComponent.prototype.toggleNavbar = function () {
        this.navbarOpen = !this.navbarOpen;
    };
    ShopComponent.prototype.setTotalCartProductsQuantity = function () {
        var cartProductsArr = this.authService.userCart.products;
        var cartProductsQuantityArr = cartProductsArr.map(function (obj) { return obj.quantity; });
        this.totalCartProductsQuantity = cartProductsQuantityArr.reduce(function (a, b) { return a + b; }, 0);
    };
...
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent.prototype.onFirstStepSubmit = function () {
        var _this = this;
        if (this.authService.isLoggedUser()) {
            this.router.navigate(['dashboard']);
        }
        var signUpDetails = this.firstFormGroup.getRawValue();
        var identityNumber = signUpDetails.identityNumber.toString();
        var credentials = {
        ...
        this.authService.checkUserCredentials(credentials).subscribe(function (data) {
            if (data.userChecked) {
            ...
            if (err.status === 400) {
                Object.keys(err.error).forEach(function (prop) {
                    var formControl = _this.firstFormGroup.get(prop);
                    if (formControl) {
    ...
    SignupComponent.prototype.onSecondStepSubmit = function () {
        var _this = this;
        var credentials = this.firstFormGroup.getRawValue();
        var shippingDetails = this.secondFormGroup.getRawValue();
        var identityNumber = credentials.identityNumber.toString();
        var user = {
        ...
        this.authService.registerUser(user).subscribe(function (user) {
            ...
            if (user) {
                ...
                _this.redirectToDashboard(loginDetails);
            }
        }, function (err) {
            if (err.status === 400) {
                Object.keys(err.error).forEach(function (prop) {
                    var formControl = _this.secondFormGroup.get(prop);
                    if (formControl) {
                        formControl.setErrors({
                            serverError: err.error[prop]
                        });
                ...
                _this.userIsReistered = false;
            }
        });
    };
    SignupComponent.prototype.goForward = function (stepper) {
        var _this = this;
        setTimeout(function () {
    ...
    SignupComponent.prototype.allowNumberOnly = function (e) {
        var code = (e.which) ? e.which : e.keycode;
        if (code > 31 && (code < 48 || code > 57)) {
            e.preventDefault();
        }
    };
    SignupComponent.prototype.preventPaste = function (e) {
        e.preventDefault();
        return false;
    };
    SignupComponent.prototype.redirectToDashboard = function (loginDetails) {
        var _this = this;
        this.authService.loginUser(loginDetails).subscribe(function (data) {
            if (data.success) {
                _this.authService.storeUserData(data.token, data.user);
...
var AdminGuard = /** @class */ (function () {
    ...
    AdminGuard.prototype.canActivate = function () {
        this.authService.loadToken();
        this.userToken = this.authService.currentUserToken;
        var tokenInfo = this.authService.getDecodedAccessToken(this.userToken);
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        ...
        this.storeCartData = function (currentUserCart) {
            localStorage.setItem('cart', JSON.stringify(currentUserCart));
        };
        this.getDecodedAccessToken = function (token) {
            try {
    ...
    AuthService.prototype.checkUserCredentials = function (userCredentials) {
    ...
    AuthService.prototype.loginUser = function (loginDetails) {
        return this.http.post('api/user/login', loginDetails, httpOptions);
    };
    AuthService.prototype.checkIfUserAdmin = function (userId) {
        return this.http.get("api/user/checkIfUserAdmin/" + userId);
    };
    AuthService.prototype.storeUserData = function (token, loggedUser) {
    ...
    AuthService.prototype.loadUserPayload = function () {
    ...
    AuthService.prototype.loadUserCart = function () {
...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.geAllCategories = function () {
...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.getAllOrders = function (token) {
        return this.http.get('api/order/orders', { headers: { Authorization: token } });
    };
    OrderService.prototype.getAllOrdersLength = function () {
        return this.http.get('api/order/ordersLength');
    };
    OrderService.prototype.createNewOrder = function (order, token) {
        return this.http.post('api/order/createNewOrder', order, { headers: { Authorization: token } });
    };
    OrderService.prototype.getOccupiedDates = function (token) {
        return this.http.get('api/order/getOccupiedDates', { headers: { Authorization: token } });
    };
    OrderService.prototype.getLatestOrderByUserId = function (userId, token) {
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.editProduct = function (productId, editedProduct, token) {
        return this.http.put("api/product/editProductById/" + productId, editedProduct, { headers: { Authorization: token } });
    };
    ProductService.prototype.createNewProduct = function (product, token) {
